...
export default function AdminSidebar() {
  ...
  return (
    <aside className="sticky top-0 h-screen w-64 bg-black border-r border-white/[0.06] flex flex-col flex-shrink-0 overflow-y-auto">
      {/* Logo */}
        ...
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              <item.icon
                size={16}
                className={isActive ? "text-red-400" : "text-white/40 group-hover:text-white/70"}
              />
              {item.label}
